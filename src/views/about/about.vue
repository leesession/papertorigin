    ...
    .box {
        ...
        li {
            ...
            .bg {
                width: 1095px;
                height: 35px;
                background: url(../../assets/images/shodow.png) no-repeat center center;
            ...
            &:hover {
                ...
                .cont div{
                    background:linear-gradient(242deg,rgba(48,124,149,1),rgba(66,50,109,1));
                    opacity:0.9;
                    color: #fff !important;
                    h4,p{
                        color: #fff;
            ...
            .cont {
                width: 100%;
                height: 214px;
                box-shadow: 0 5px 10px rgba(39, 91, 131, 0.18);
                display: flex;
